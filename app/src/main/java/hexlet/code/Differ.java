...
public class Differ {
    public static String generate(String filepath1, String filepath2, String formatterName) throws Exception {
        Map<String, Object> map1 = readDataFromFile(filepath1);
        Map<String, Object> map2 = readDataFromFile(filepath2);
    ...
    private static Map<String, Object> readDataFromFile(String filePath) throws Exception {
